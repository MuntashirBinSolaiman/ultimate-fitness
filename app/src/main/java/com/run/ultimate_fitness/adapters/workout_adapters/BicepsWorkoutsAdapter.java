...
public class BicepsWorkoutsAdapter extends RecyclerView.Adapter<BicepsWorkoutsAdapter.ViewHolder> {

    List<WorkoutsModel>workoutsList1;
    private OnWorkoutListener mOnWorkoutListener;

    public BicepsWorkoutsAdapter(List<WorkoutsModel> workoutsList, OnWorkoutListener onWorkoutListener){
    ...
    @NonNull
    @Override
    public BicepsWorkoutsAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull BicepsWorkoutsAdapter.ViewHolder holder, int position) {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void onClick(View view) {
            ...
            onWorkoutListener.onBicepsWorkoutClick(getAbsoluteAdapterPosition());

        }
    }

    public interface OnWorkoutListener{
        void onBicepsWorkoutClick(int position);
    }
}
