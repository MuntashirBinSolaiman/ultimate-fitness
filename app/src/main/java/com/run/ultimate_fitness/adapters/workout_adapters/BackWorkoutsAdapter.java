...
public class BackWorkoutsAdapter extends RecyclerView.Adapter<BackWorkoutsAdapter.ViewHolder> {

    List<WorkoutsModel>workoutsList1;
    private OnWorkoutListener mOnWorkoutListener;

    public BackWorkoutsAdapter(List<WorkoutsModel> workoutsList, OnWorkoutListener onWorkoutListener){
    ...
    @NonNull
    @Override
    public BackWorkoutsAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull BackWorkoutsAdapter.ViewHolder holder, int position) {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void onClick(View view) {
            ...
            onWorkoutListener.onBackWorkoutClick(getAbsoluteAdapterPosition());

        }
    }

    public interface OnWorkoutListener{
        void onBackWorkoutClick(int position);
    }
}
